# Run log (benchmark3) — 2026-07-17T10:12:14
...
sam3.pt -> /root/.cache/huggingface/hub/models--facebook--sam3/snapshots/3c879f39826c281e95690f02c7821c4de09afae7/sam3.pt
...
downloading Depth Pro checkpoint (~1.9GB)...
WARNING ⚠️ imgsz=[640] must be multiple of max stride 14, updating to [644]
WARNING ⚠️ imgsz=[640] must be multiple of max stride 14, updating to [644]
WARNING ⚠️ imgsz=[640] must be multiple of max stride 14, updating to [644]
WARNING ⚠️ imgsz=[640] must be multiple of max stride 14, updating to [644]
...
WARNING ⚠️ imgsz=[640] must be multiple of max stride 14, updating to [644]
WARNING ⚠️ imgsz=[640] must be multiple of max stride 14, updating to [644]
SAM 3 detection:  {'red_cube': 'det 20/20, px 58.7', 'green_sphere': 'det 20/20, px 0.4', 'blue_tall': 'det 20/20, px 58.6', 'yellow_cyl': 'det 2/20, px 38.3', 'container': 'det 19/20, px 4.8'}
```
...
\n[floor_shape]  (x / y / z / loc-med / loc-p95)
  red_cube      (box      ) x  44.2  y 106.6  z   6.8  | loc 125.7 / 214.5  (n=20)
  green_sphere  (sphere   ) x   0.9  y   0.5  z   1.0  | loc   1.5 / 2.3    (n=20)
  blue_tall     (box_tall ) x  50.5  y 105.1  z  21.3  | loc 125.7 / 206.5  (n=20)
  yellow_cyl    (cylinder ) x  52.1  y  50.3  z  11.4  | loc  74.3 / 95.2   (n=2)
  container     (container) x  58.8  y  61.0  z  40.0  | loc  93.0 / 94.7   (n=19)
\n[depthpro]  (x / y / z / loc-med / loc-p95)
  red_cube      (box      ) x  51.9  y 105.2  z  32.8  | loc 128.2 / 212.7  (n=20)
  green_sphere  (sphere   ) x  10.6  y  14.9  z  17.1  | loc  26.2 / 38.8   (n=20)
  blue_tall     (box_tall ) x  45.1  y 108.3  z   4.0  | loc 127.1 / 217.6  (n=20)
  yellow_cyl    (cylinder ) x  45.3  y  40.2  z  24.4  | loc  66.8 / 88.2   (n=2)
  container     (container) x  38.3  y  59.3  z  61.9  | loc  95.0 / 110.1  (n=19)
\nlocal ceilings (perfect masks): cube 0.5 sphere 0.7 cyl 0.7 | tall box ~18 (aspect ambiguity).
...
```text
=== results snapshot ===
results: {'floor_shape': {'red_cube': {'n': 20, 'x': 44.2, 'y': 106.6, 'z': 6.8, 'loc_med': 125.7, 'loc_p95': 214.5}, 'green_sphere': {'n': 20, 'x': 0.9, 'y': 0.5, 'z': 1.0, 'loc_med': 1.5, 'loc_p95': 2.3}, 'blue_tall': {'n': 20, 'x': 50.5, 'y': 105.1, 'z': 21.3, 'loc_med': 125.7, 'loc_p95': 206.5}, 'yellow_cyl': {'n': 2, 'x': 52.1, 'y': 50.3, 'z': 11.4, 'loc_med': 74.3, 'loc_p95': 95.2}, 'container': {'n': 19, 'x': 58.8, 'y': 61.0, 'z': 40.0, 'loc_med': 93.0, 'loc_p95': 94.7}}, 'depthpro': {'red_cube': {'n': 20, 'x': 51.9, 'y': 105.2, 'z': 32.8, 'loc_med': 128.2, 'loc_p95': 212.7}, 'green_sphere': {'n': 20, 'x': 10.6, 'y': 14.9, 'z': 17.1, 'loc_med': 26.2, 'loc_p95': 38.8}, 'blue_tall': {'n': 20, 'x': 45.1, 'y': 108.3, 'z': 4.0, 'loc_med': 127.1, 'loc_p95': 217.6}, 'yellow_cyl': {'n': 2, 'x': 45.3, 'y': 40.2, 'z': 24.4, 'loc_med': 66.8, 'loc_p95': 88.2}, 'container': {'n': 19, 'x': 38.3, 'y': 59.3, 'z': 61.9, 'loc_med': 95.0, 'loc_p95': 110.1}}}
