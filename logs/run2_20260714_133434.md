# Run log (benchmark2) — 2026-07-14T13:23:37
...
downloading Depth Pro checkpoint (~1.9GB, one-time)...
  saved viz/bench2_cropzoom.png (189 floor px in crop)
depthpro_full        n=48 | x  4.8/10.2  y  7.4/14.0  z  7.2/17.5  | loc 11.2/24.7  (med/p95 mm)
depthpro_crop        n=48 | x 20.2/42.4  y 28.4/53.8  z 33.1/69.1  | loc 48.5/95.9  (med/p95 mm)
Creating new Ultralytics Settings v0.0.6 file ✅ 
View Ultralytics Settings with 'yolo settings' or at '/root/.config/Ultralytics/settings.json'
Update Settings with 'yolo settings key=value', i.e. 'yolo settings runs_dir=path/to/dir'. For help see https://docs.ultralytics.com/quickstart/#ultralytics-settings.
[KDownloading https://github.com/ultralytics/assets/releases/download/v8.4.0/sam2_b.pt to 'sam2_b.pt': 6% ╸─────────── 10.0/154.4MB 39.8MB/s 0.3s<3.6s[KDownloading https://github.com/ultralytics/assets/releases/download/v8.4.0/sam2_b.pt to 'sam2_b.pt': 10% ━─────────── 17.0/154.4MB 69.4MB/s 0.4s<2.0s[KDownloading https://github.com/ultralytics/assets/releases/download/v8.4.0/sam2_b.pt to 'sam2_b.pt': 12% ━╸────────── 20.1/154.4MB 12.2MB/s 0.6s<11.0s[KDownloading https://github.com/ultralytics/assets/releases/download/v8.4.0/sam2_b.pt to 'sam2_b.pt': 19% ━━────────── 30.1/154.4MB 38.2MB/s 0.9s<3.3s[KDownloading https://github.com/ultralytics/assets/releases/download/v8.4.0/sam2_b.pt to 'sam2_b.pt': 25% ━━━───────── 40.1/154.4MB 39.2MB/s 1.1s<2.9s[KDownloading https://github.com/ultralytics/assets/releases/download/v8.4.0/sam2_b.pt to 'sam2_b.pt': 32% ━━━╸──────── 50.0/154.4MB 40.2MB/s 1.4s<2.6s[KDownloading https://github.com/ultralytics/assets/releases/download/v8.4.0/sam2_b.pt to 'sam2_b.pt': 38% ━━━━╸─────── 60.1/154.4MB 41.8MB/s 1.6s<2.3s[KDownloading https://github.com/ultralytics/assets/releases/download/v8.4.0/sam2_b.pt to 'sam2_b.pt': 45% ━━━━━─────── 70.1/154.4MB 13.2MB/s 2.4s<6.4s[KDownloading https://github.com/ultralytics/assets/releases/download/v8.4.0/sam2_b.pt to 'sam2_b.pt': 51% ━━━━━━────── 80.1/154.4MB 37.0MB/s 2.6s<2.0s[KDownloading https://github.com/ultralytics/assets/releases/download/v8.4.0/sam2_b.pt to 'sam2_b.pt': 58% ━━━━━━╸───── 90.0/154.4MB 40.7MB/s 2.9s<1.6s[KDownloading https://github.com/ultralytics/assets/releases/download/v8.4.0/sam2_b.pt to 'sam2_b.pt': 64% ━━━━━━━╸──── 100.0/154.4MB 39.4MB/s 3.1s<1.4s[KDownloading https://github.com/ultralytics/assets/releases/download/v8.4.0/sam2_b.pt to 'sam2_b.pt': 71% ━━━━━━━━╸─── 110.1/154.4MB 42.5MB/s 3.4s<1.0s[KDownloading https://github.com/ultralytics/assets/releases/download/v8.4.0/sam2_b.pt to 'sam2_b.pt': 77% ━━━━━━━━━─── 120.1/154.4MB 39.1MB/s 3.6s<0.9s[KDownloading https://github.com/ultralytics/assets/releases/download/v8.4.0/sam2_b.pt to 'sam2_b.pt': 84% ━━━━━━━━━━── 130.2/154.4MB 41.6MB/s 3.9s<0.6s[KDownloading https://github.com/ultralytics/assets/releases/download/v8.4.0/sam2_b.pt to 'sam2_b.pt': 90% ━━━━━━━━━━╸─ 140.0/154.4MB 36.3MB/s 4.1s<0.4s[KDownloading https://github.com/ultralytics/assets/releases/download/v8.4.0/sam2_b.pt to 'sam2_b.pt': 97% ━━━━━━━━━━━╸ 150.1/154.4MB 38.3MB/s 4.4s<0.1s[KDownloading https://github.com/ultralytics/assets/releases/download/v8.4.0/sam2_b.pt to 'sam2_b.pt': 100% ━━━━━━━━━━━━ 154.4MB 34.9MB/s 4.4s
floor_inferz         n=48 | x  1.7/2.1   y  0.9/1.8   z  1.2/2.2   | loc  2.3/3.7   (med/p95 mm)
...
depthpro_cropzoom       20/42    28/54    33/69     48/96   
floor_INFERZ             2/2      1/2      1/2       2/4    
...
```text
=== results snapshot ===
results: {'depthpro_fullframe': {'n': 48, 'x_med': 4.8, 'x_p95': 10.2, 'y_med': 7.4, 'y_p95': 14.0, 'z_med': 7.2, 'z_p95': 17.5, 'loc_med': 11.2, 'loc_p95': 24.7}, 'depthpro_cropzoom': {'n': 48, 'x_med': 20.2, 'x_p95': 42.4, 'y_med': 28.4, 'y_p95': 53.8, 'z_med': 33.1, 'z_p95': 69.1, 'loc_med': 48.5, 'loc_p95': 95.9}, 'floor_INFERZ': {'n': 48, 'x_med': 1.7, 'x_p95': 2.1, 'y_med': 0.9, 'y_p95': 1.8, 'z_med': 1.2, 'z_p95': 2.2, 'loc_med': 2.3, 'loc_p95': 3.7}, 'floor_contact_z0': {'n': 48, 'x_med': 10.3, 'x_p95': 11.3, 'y_med': 14.2, 'y_p95': 17.9, 'z_med': 15.0, 'z_p95': 15.0, 'loc_med': 23.1, 'loc_p95': 25.4}, 'floor_contact_zhalf': {'n': 48, 'x_med': 0.9, 'x_p95': 1.7, 'y_med': 0.3, 'y_p95': 1.9, 'z_med': 0.0, 'z_p95': 0.0, 'loc_med': 1.0, 'loc_p95': 3.4}}
