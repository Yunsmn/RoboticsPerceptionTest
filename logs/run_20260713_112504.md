...
Warning: You are sending unauthenticated requests to the HF Hub. Please set a HF_TOKEN to enable higher rate limits and faster downloads.
  unidepth_v2: gt_depth vs pred_depth (first 6 frames)
    frames/pose_000.png gt 0.956 m   pred 2.486 m   ratio 0.38
    frames/pose_001.png gt 0.979 m   pred 2.568 m   ratio 0.38
    frames/pose_002.png gt 1.002 m   pred 2.636 m   ratio 0.38
    frames/pose_003.png gt 1.025 m   pred 2.675 m   ratio 0.38
    frames/pose_004.png gt 1.048 m   pred 2.598 m   ratio 0.40
    frames/pose_005.png gt 1.072 m   pred 2.605 m   ratio 0.41
  -> unidepth_v2 {'n': 48, 'loc_median_mm': 1626.1, 'loc_p95_mm': 1826.7, 'median_gt_over_pred': 0.384, 'scaled_loc_median_mm': 8.8, 'scaled_loc_p95_mm': 72.1}
```
...
```text
=== results snapshot ===
results: {'unidepth_v2': {'n': 48, 'loc_median_mm': 1626.1, 'loc_p95_mm': 1826.7, 'median_gt_over_pred': 0.384, 'scaled_loc_median_mm': 8.8, 'scaled_loc_p95_mm': 72.1}}
