...
**output:**
```text
  depth_pro: gt_depth vs pred_depth (first 6 frames)
    frames/pose_000.png gt 0.956 m   pred 1.460 m   ratio 0.65
    frames/pose_001.png gt 0.979 m   pred 1.526 m   ratio 0.64
    frames/pose_002.png gt 1.002 m   pred 1.602 m   ratio 0.63
    frames/pose_003.png gt 1.025 m   pred 1.582 m   ratio 0.65
    frames/pose_004.png gt 1.048 m   pred 1.626 m   ratio 0.64
    frames/pose_005.png gt 1.072 m   pred 1.713 m   ratio 0.63
  -> depth_pro {'n': 48, 'loc_median_mm': 603.0, 'loc_p95_mm': 662.5, 'median_gt_over_pred': 0.639, 'scaled_loc_median_mm': 9.4, 'scaled_loc_p95_mm': 30.4}
```
...
```text
=== results snapshot ===
results: {'depth_pro': {'n': 48, 'loc_median_mm': 603.0, 'loc_p95_mm': 662.5, 'median_gt_over_pred': 0.639, 'scaled_loc_median_mm': 9.4, 'scaled_loc_p95_mm': 30.4}}
